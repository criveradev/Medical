...
const { listar, obtener, crear, actualizar, actualizarHorarios, disponibilidad, subirFoto, siguienteMatricula, miPerfil } = require('../../controllers/v1/doctores.controller');
